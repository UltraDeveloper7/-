...
Welcome_Message.setpos(0,180)
Welcome_Message.write("Καλώς ήρθες {}!!". format(str(Pilot)), align = "center", font = ("Courier", 40 ))

Welcome_Message1 = Message()
Welcome_Message1.setpos(0,120)
Welcome_Message1.write("Είσαι έτοιμος να αρχίσεις;", align = "center", font = ("Courier", 40))

Welcome_Message2 = Message()
Welcome_Message2.setpos(0,-200)
Welcome_Message2.color("red")
Welcome_Message2.write("Πάτα 's' για να αρχίσεις!", align = "center",  font = ("Arial", 40))

Welcome_Message3 = Message()
Welcome_Message3.setpos(0,-260)
Welcome_Message3.color("red")
Welcome_Message3.write("Πάτα 'f' για οδηγίες!", align = "center",  font = ("Arial", 40))

Welcome_Message4 = Message()
Welcome_Message4.setpos(0,-300)
Welcome_Message4.color("red")
Welcome_Message4.write("Κατάφερε να αναχαιτίσεις 100 κομήτες!", align = "center", font = ("Arial", 28))



#Instruction Message 
Instruction_Message = Message()
Instruction_Message.setpos(110, -120 )
...
def Instructions2():
    ...
    Instruction_Message.write("Γεία σου {},\
...
while running :
    ...
    if Comet != 10 :  
        ...
        if lifes > 0:
            ...
            if Game_Over == True and running == True  : # if these two boolean variables return True, then do the below actions:
                ...
                if str(int(score_count)) == '1' or Comet == 1 :
                    message.write('Τελικό σκορ: {}'.format(str(int(score_count))), \
                                    align = "center", font = ("Courier", 45, "normal"))
                    message1.write("Αναχαίτισες {} κομήτη.". format(Comet), \
                                    align = "center", font = ("Courier", 45, "normal"))
                    message2.write("Θα μπορούσες και καλύτερα την επόμενη φορά {}".format(str(Pilot)), \
                                    align = "center", font = ("Courier", 20, "normal"))

                elif  20 == Comet < 100:
                    message.write("Πολύ καλή δουλειά {}!!". format(str(Pilot)), \
                                    align = "center", font = ("Courier", 45, "normal"))
                    message1.write('Σκόραρες: {} '.format(str(int(score_count))), \
                                    align = "center", font = ("Courier", 45, "normal"))
                    ...
                    message.write('Τελικό σκορ: {}'.format(str(int(score_count))), \
                                    align = "center", font = ("Courier", 45, "normal"))
                    message1.write("Δεν αναχαίτισες κανένα κομήτη!", \
                                    align = "center", font = ("Courier", 35, "normal"))
                    message2.write("Μπορείς και καλύτερα {}!". format(str(Pilot)), \
                                    align = "center", font = ("Courier", 25, "normal"))

                else:
                    message.write('Το σκορ σου είναι: {}'.format(str(int(score_count))),  \
                                    align = "center", font = ("Courier", 45, "normal"))
                    message1.write("Αναχαίτισες {} κομήτες.". format(Comet), \
                                    align = "center", font = ("Courier", 45, "normal"))
                    message2.write("Συνέχισε την σκληρή δουλειά {}!!". format(str(Pilot)), \
                                    align = "center", font = ("Courier", 20, "normal"))
        ...
        if Victory == True and running == True : # if these two boolean variables return True, then do the below actions:
            ...
            Life_board.clear()
            wn.update()
            message.write(" {} νίκησες!!".format(str(Pilot)), \
